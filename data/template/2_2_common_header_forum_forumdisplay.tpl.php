...
0
|| checktplrefresh('./template/dfsj_poertklmnr/common/header.htm', './template/dfsj_poertklmnr/common/header_common.htm', 1461668549, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/dfsj_poertklmnr', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/dfsj_poertklmnr/common/header.htm', './template/default/common/header_qmenu.htm', 1461668549, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/dfsj_poertklmnr', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/dfsj_poertklmnr/common/header.htm', './template/default/common/pubsearchform.htm', 1461668549, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/dfsj_poertklmnr', 'common/header_forum_forumdisplay')
;?>
...
<script src="<?php echo $_G['setting']['jspath'];?>common.js?<?php echo VERHASH;?>" type="text/javascript"></script><?php include_once './template/dfsj_poertklmnr/dfsj_imgs/dfsj_language.'.currentlang().'.php';?><?php if(empty($_GET['diy'])) { $_GET['diy'] = '';?><?php } if(!isset($topic)) { $topic = array();?><?php } ?>
...
<?php } ?><div id="nv">
<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">快速发帖</a>
