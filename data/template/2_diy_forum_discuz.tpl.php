...
<div class="bm_h cl">
<span class="o">
<img id="category_-1_img" src="<?php echo $_G['style']['styleimgdir'];?>/<?php echo $collapse['collapseimg_-1'];?>" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('category_-1');" />
</span>
...
<div class="bm_h cl">
<span class="o">
<img id="category_0_img" src="<?php echo $_G['style']['styleimgdir'];?>/<?php echo $collapse['collapseimg_0'];?>" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('category_0');" />
</span>
...
<td class="fl_i">
<?php if(empty($forum['redirect'])) { ?><span class="xi2"><?php echo $forum['threads'];?></span><br />主题<?php } ?>
</td>
<td class="fl_i">
<?php if(empty($forum['redirect'])) { ?><span class="xg1"><?php echo $forum['posts'];?></span><br />帖数<?php } ?>
</td>
<td class="fl_by">
<div>
<?php if($forum['permission'] == 1) { ?>
