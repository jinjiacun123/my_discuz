...
0
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seditor.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/upload.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seccheck.htm', 1461666281, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/dfsj_poertklmnr', 'forum/viewthread')
...
<?php } ?>
<span class="pipe">|</span><a href="forum.php?mod=topicadmin&amp;action=getip&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $post['pid'];?><?php if($_G['forum_auditstatuson']) { ?>&amp;modthreadkey=<?php echo $_GET['modthreadkey'];?><?php } ?>" onclick="ajaxmenu(this, 0, 0, 2);doane(event)">IP</a>
